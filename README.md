...
##  Descrição:
A detecção de fraudes em cartões de crédito representa um obstáculo mundial tanto para bancos quanto para consumidores. Identificar transações ilícitas com agilidade e precisão permite evitar prejuízos expressivos e fortalecer a confiança dos usuários no sistema financeiro.
## Foco:
Este projeto tem como foco desenvolver um modelo de aprendizado de máquina robusto e eficaz para prever se uma transação de cartão de crédito é fraudulenta.
## Base de dados:
